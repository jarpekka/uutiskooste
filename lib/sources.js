...
const STOCKHOLM_EVENT_TERMS = [
  ...STOCKHOLM_TRAVEL_TERMS,
  "arts culture",
  "arts & culture",
  "art",
  "culture",
...
const STOCKHOLM_EXCLUSIONS = COMMON_EXCLUSIONS.filter((term) => !["guide", "opas"].includes(term));
const STOCKHOLM_LOCAL_EXCLUSIONS = [
  ...STOCKHOLM_EXCLUSIONS,
  "playlist",
  "new music friday",
  "interview"
];
...
const SOURCES = [
  ...
  },
  {
    ...
    areas: ["tukholma"],
    site: "https://www.visitstockholm.com",
    pageUrls: [
      "https://www.visitstockholm.com/",
      "https://www.visitstockholm.com/events/",
      "https://www.visitstockholm.com/see-do/",
      "https://www.visitstockholm.com/travel-info/"
    ],
    allowedLanguages: ["en"],
    primaryNewsSource: true,
    topicKeywords: STOCKHOLM_TRAVEL_TERMS,
    boostKeywords: STOCKHOLM_BOOST_TERMS,
    exclude: STOCKHOLM_EXCLUSIONS
  },
  {
    name: "Time Out Stockholm",
    areas: ["tukholma"],
    site: "https://www.timeout.com",
    pageUrls: [
      "https://www.timeout.com/stockholm",
      "https://www.timeout.com/stockholm/things-to-do",
      "https://www.timeout.com/stockholm/restaurants",
      "https://www.timeout.com/stockholm/bars"
    ],
    allowedLanguages: ["en"],
    primaryNewsSource: true,
    topicKeywords: STOCKHOLM_TRAVEL_TERMS,
  ...
  {
    name: "Visit Sweden / Stockholm",
    areas: ["tukholma"],
    site: "https://visitsweden.com",
    pageUrls: [
      "https://visitsweden.com/where-to-go/middle-sweden/stockholm/",
      "https://visitsweden.com/what-to-do/nature-outdoors/",
      "https://visitsweden.com/what-to-do/culture-history-and-art/",
  ...
  },
  {
    name: "View Stockholm",
    areas: ["tukholma"],
    site: "https://viewstockholm.com",
    pageUrls: [
      "https://viewstockholm.com/",
      "https://viewstockholm.com/best-of-stockholm-archipelago/",
      "https://viewstockholm.com/best-museums-stockholm/"
    ],
    allowedLanguages: ["en"],
  ...
  {
    name: "Your Living City",
    areas: ["tukholma"],
    site: "https://www.yourlivingcity.com",
    feedUrls: ["https://www.yourlivingcity.com/feed/"],
    pageUrls: [
      "https://www.yourlivingcity.com/category/cultural/events/",
      "https://www.yourlivingcity.com/category/community/tourist-information/",
      "https://www.yourlivingcity.com/category/lifestyle/cafe-culture/",
      "https://www.yourlivingcity.com/category/dining-out/"
    ],
    allowedLanguages: ["en"],
    primaryNewsSource: false,
    topicKeywords: STOCKHOLM_TRAVEL_TERMS,
    boostKeywords: STOCKHOLM_BOOST_TERMS,
    exclude: STOCKHOLM_LOCAL_EXCLUSIONS
  },
  {
    name: "SOMO Stockholm Events",
    areas: ["tukholma"],
    site: "https://somo.social",
    pageUrls: [
      "https://somo.social/en/events/stockholm/",
      "https://somo.social/en/events/stockholm/?date=this-week&categories=arts-culture",
      "https://somo.social/en/events/stockholm/?date=this-week&categories=music-concerts"
    ],
    allowedLanguages: ["en"],
    primaryNewsSource: false,
    topicKeywords: STOCKHOLM_EVENT_TERMS,
    boostKeywords: [
      "arts culture",
      "arts & culture",
      "music concerts",
      ...
      "performance",
      "this week",
      ...STOCKHOLM_BOOST_TERMS
    ],
    exclude: STOCKHOLM_EXCLUSIONS,
    note: "SOMO on lisatty Tukholman kuluvan viikon Arts & culture- ja Music & concerts -tapahtumia varten. Sivusto voi estaa palvelinhaun 403-virheella."
  },
  {
    name: "Konserthuset Stockholm",
    areas: ["tukholma"],
    site: "https://www.konserthuset.se",
    pageUrls: [
      "https://www.konserthuset.se/en/programme/calendar/",
      "https://www.konserthuset.se/en/programme/festivals--themes/"
    ],
    allowedLanguages: ["en"],
    primaryNewsSource: false,
    topicKeywords: STOCKHOLM_EVENT_TERMS,
  ...
  },
  {
    name: "Debaser",
    areas: ["tukholma"],
    site: "https://debaser.se",
    pageUrls: [
      "https://debaser.se/",
      "https://debaser.se/kalender",
      "https://debaser.se/events"
    ],
  ...
  },
  {
    ...
    pageUrls: [
      "https://www.fasching.se/",
      "https://www.fasching.se/kalendarium/"
    ],
    allowedLanguages: ["sv", "en"],
    primaryNewsSource: false,
    topicKeywords: STOCKHOLM_EVENT_TERMS,
  ...
  {
    name: "Stadsmuseet Stockholm",
    areas: ["tukholma"],
    site: "https://stadsmuseet.stockholm",
    pageUrls: [
      "https://stadsmuseet.stockholm/aktuellt/kalendarium/",
      "https://stadsmuseet.stockholm/visningar-och-stadsvandringar/",
      "https://stadsmuseet.stockholm/utstallningar/"
    ],
    allowedLanguages: ["sv", "en"],
    primaryNewsSource: false,
    topicKeywords: STOCKHOLM_EVENT_TERMS,
