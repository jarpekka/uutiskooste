...
const MUSIC_NEWS_RELEASE_TERMS = [
  ...MUSIC_RELEASE_TERMS.filter((term) => !["album", "single", "lp", "ep"].includes(term)),
  "new album",
  "announces album",
  "announced album",
  "upcoming album",
...
const SOURCES = [
  ...
  },
  {
    ...
    allowedLanguages: ["en"],
    primaryNewsSource: true,
    requiredCategories: ["ai", "artificial intelligence"],
    topicKeywords: AI_TOPIC_TERMS,
    exclude: COMMON_EXCLUSIONS
  },
  {
  ...
  },
  {
    ...
    articlePathPatterns: ["/tudum/articles/"],
    allowedLanguages: ["en"],
    primaryNewsSource: true,
  ...
  },
  {
    ...
    articlePathPatterns: ["/tv-pr/news/"],
    allowedLanguages: ["en"],
    primaryNewsSource: true,
  ...
  },
  {
    ...
    articlePathPatterns: ["/fi/elokuva/", "/fi/sarja/"],
    allowUndatedItems: true,
  ...
  },
  {
    ...
    allowedLanguages: ["en"],
    primaryNewsSource: true,
    requiredKeywordGroups: [MUSIC_RELEASE_TERMS],
    boostKeywords: MUSIC_RELEASE_TERMS,
  ...
  },
  {
    ...
    allowedLanguages: ["en"],
    primaryNewsSource: false,
    requiredKeywordGroups: [MUSIC_GENRE_TERMS, MUSIC_NEWS_RELEASE_TERMS],
    exclude: MUSIC_EXCLUSIONS
  },
  {
    name: "NME / Music News",
